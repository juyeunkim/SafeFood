...
public class PageBean implements Serializable{
	/**검색 조건*/
	private String key;	// 상품명, 가격 등 분류해서 넣을 키워드
	/**검색 단어*/
	private String word;	// text 단어
	/**페이징 처리에 대한 link정보*/
	private String pagelink;	// 페이지 번호 링크를 만들어 주기 위함
	/**현재 페이지 번호*/
	private int pageNo;
	/**한 페이지에 보여주 content 개수*/
	private int interval = 10;	// 게시글 정보를 몇개를 보여줄 것인가.
	/**페이지 시작 번호*/
	private int start=0;
	public PageBean() {	}
